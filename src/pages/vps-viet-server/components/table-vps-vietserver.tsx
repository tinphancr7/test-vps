...
function TableVpsVietServer() {
  ...
  const handleNavigateToDetail = (id: string) => {
    navigate(`${paths.vps_management_vietserver}/${id}/overview`);
  };
  ...
  const handleRenewVPS = async (item: any, value: any) => {
    ...
    dispatch(asyncThunkPaginationVpsVietServer(search));
    showToast(
...
export default TableVpsVietServer;
