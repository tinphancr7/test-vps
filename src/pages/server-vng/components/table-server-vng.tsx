import serverVngApis from '@/apis/server-vng-api';
import Container from '@/components/container';
import TableControl from '@/components/table-control';
import { useAppDispatch, useAppSelector } from '@/stores';
import { asyncThunkPaginationServerVng } from '@/stores/async-thunks/server-vng-thunk';
...
function TableServerVng() {
    ...
    const { serverList, total, isLoading } = useAppSelector((state) => state.serverVng);
    const tableServerVng = useAppSelector((state) => state.table['server_vng']);
    ...
    useEffect(() => {
        ...
        if (tableServerVng) {
            ...
            dispatch(asyncThunkPaginationServerVng(query));
        }
    ...
    const handleCopyPw = useCallback(
        async (id: string) => {
            ...
            try {
                const { data } = await serverVngApis.getPwServer(id as string);
