...
function ModalAssignedUserToServer({ isOpen, onOpenChange }: any) {
    ...
    const tableVpsVng = useAppSelector((state) => state.table['server_vietserver']);
    ...
    const getInfoListServer = async () => {
        try {
            ...
            const result = await serverVietServerApis.getListServerAdmin(listKey.join(','));
    ...
    const handleSubmit = async () => {
        try {
            ...
            await serverVietServerApis.updateAssignedServerToUser(listServerid, listUserId);
