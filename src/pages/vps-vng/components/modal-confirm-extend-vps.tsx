...
function ConfirmExtendVPS({ isOpen, onOpenChange }: any) {
  ...
  const tableVpsVng: any = useAppSelector((state) => state.table["vps_vng"]);
  const [list, setList] = useState<any[]>([]);

  // const list = useMemo(() => {
  //   console.log(tableVpsVng?.selectedKeys);
  //   const listSelect = [...(tableVpsVng?.selectedKeys || "")];
