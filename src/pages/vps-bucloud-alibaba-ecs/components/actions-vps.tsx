...
function ActionsVps({ item }: { item: any }) {
    ...
    const handleShutdownVps = async () => {
        try {
            ...
            const { data } = await buCloudAlibabaEcsApis.stopInstance(item?.InstanceId);
    ...
    const handleRebootVps = async () => {
        try {
            ...
            setStatusVps("pending");
            const { data } = await buCloudAlibabaEcsApis.rebootInstance(item?.InstanceId);
    ...
    const handleStartVps = async () => {
        try {
            ...
            setStatusVps("pending");
            const { data } = await buCloudAlibabaEcsApis.startInstance(item?.InstanceId);
