...
export const updateSettingLoadBalancer: any = createAsyncThunk(
  ...
  async (data: any, { rejectWithValue }) => {
    try {
      const response =
        await digitalOceanBuCloudApi.updateSettingLoadBalancerDigitalOcean(
          data?._id,
          data
        );
...
export const loadBalancerEditDigitalOceanBuCloud = createSlice({
...
export const { setDataSettingLoadBalancer } =
  loadBalancerEditDigitalOceanBuCloud.actions;

export default loadBalancerEditDigitalOceanBuCloud.reducer;
