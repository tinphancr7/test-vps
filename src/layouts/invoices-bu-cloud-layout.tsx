...
function InvoicesBuCloudLayout() {
  ...
  const tabs: Array<TabVps> = [
    ...
    },
    {
      ...
      href: paths.invoices_bu_cloud_do,
    },
    {
      key: "amazon-lightsail",
      label: "Amazon Lightsail",
      icon: <FaAws className="size-5 min-w-5" />,
      href: paths.invoices_bu_cloud_aws,
    },
    {
      key: "upcloud",
      label: "UpCloud",
      icon: <SiUpcloud className="size-5 min-w-5" />,
      href: paths.invoices_bu_cloud_up,
    },
    {
      key: "scaleway",
      label: "Scaleway",
      icon: <FaAws className="size-5 min-w-5" />,
      href: paths.invoices_bu_cloud_sc,
    },
  ];
        ...
        <div className="flex flex-col gap-3 h-full">
          <Container>
            <Tabs
              ...
              variant="underlined"
              classNames={{
                tabList: "gap-6 w-full relative rounded-none p-0 overflow-x-auto pb-0 max-xl:pb-4 scroll-main-x scrollbar-default",
...
export default InvoicesBuCloudLayout;
