...
const CreateVPSDigitalOcean = lazy(() => import("@/pages/digital-ocean/create-vps/CreateVPSDigitalOcean"))
const CreateLoadBalancerDigitalOcean = lazy(() => import("@/pages/digital-ocean/load-balancer/CreateLoadBalancerDigitalOcean"))
const VpsManagementLayout = lazy(() => import("@/layouts/vps-management-layout"))
const AccountPage = lazy(() => import("@/pages/accounts"))
const StatisticPage = lazy(() => import("@/pages/statistics"))
const ManagementLoadBalancerDigitalOcean = lazy(() => import("@/pages/digital-ocean/manage-load-balancer/ManagementLoadBalancerDigitalOcean"))
const BuCloud = lazy(() => import("@/pages/bu-cloud/create-vps/BuCloud"))
const InitializeVPSBuCloud = lazy(() => import("@/pages/bu-cloud/create-vps/initialize-vps-bu-cloud/InitializeVPSBuCloud"))
const DetailVPSBuCloud = lazy(() => import("@/pages/bu-cloud/manage-vps/service-bucloud/detail-vps"))
const ManageBuCloud = lazy(() => import("@/pages/bu-cloud/manage-vps/ManageBuCloud"))
const ManagementDetailVPSBuCLoudDigitalOcean = lazy(() => import("@/pages/bu-cloud/manage-vps/service-digitalocean/detail-vps/ManagementDetailVPSBuCLoudDigitalOcean"))
const BuyVpsScaleway = lazy(() => import("@/pages/buy-vps-scaleway"))
const DetailVPSScaleWay = lazy(() => import("@/pages/detail-vps-scaleway"))
const CloudflareAccountDetail = lazy(() => import("@/pages/cloudflare/detail-account"))
const CloudFlareDetailLayout = lazy(() => import("@/layouts/cloudflare-detail-layout"))
const CloudflareRulesetPage = lazy(() => import("@/pages/cloudflare-waf"))
const BuyDomainPage = lazy(() => import("@/pages/buy-domain"))
const WhoIsDomainPage = lazy(() => import("@/pages/who-is-domain"))
const DomainProviderPage = lazy(() => import("@/pages/domain-provider"))
const OrderDomainLogPage = lazy(() => import("@/pages/order-domain-log"))
const Domains = lazy(() => import("@/pages/domains"))

const OrderDomain = lazy(() => import("@/pages/order-domain"));
const OrderDomainStatus = lazy(() => import("@/pages/order-domain-status"));
...
const routes = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: paths.order_domain_status,
        element: (
          <Suspense fallback={<LazyLoadingPage />}>
            <OrderDomainStatus />
          </Suspense>
