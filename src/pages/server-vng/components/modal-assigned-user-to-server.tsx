...
function ModalAssignedUserToServer({ isOpen, onOpenChange }: any) {
    ...
    const tableVpsVng = useAppSelector((state) => state.table['server_vng']);
    ...
    const getInfoListServer = async () => {
        try {
            ...
            const result = await serverVngApis.getListServerAdmin(listKey.join(','));
    ...
    const handleSubmit = async () => {
        try {
            ...
            await serverVngApis.updateAssignedServerToUser(listServerid, listUserId);
