...
function ModalAddVPSLoadBalancer({
    ...
    const getListVPSInRegion = async () => {
        const response = await digitalOceanRegionApi.getAllVPSByTeamIdInRegion(
    ...
    const handleAddVPSIntoLoadBalancer = async () => {
        ...
        const add = await digitalOceanApi.addVPSIntoLoadBalancerDigitalOcean(
            info?._id,
            req
        );
        setLoading(false);
                        ...
                        <>
                            <ModalHeader className="flex flex-col gap-1">
                                <div>
                                    ...
                                    <p>
                                        Có trong khu vực - {info?.region?.name}
                                    </p>
